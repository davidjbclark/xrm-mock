...
var DataMock = /** @class */ (function () {
    function DataMock(entity, process) {
        ...
        this.entity = entity;
        this.process = process ? process : new processmanager_mock_1.ProcessManagerMock([]);
        this.loadEventHandlers = [];
    }
    DataMock.prototype.refresh = function (save) {
        var _this = this;
        return this.refreshDelegate != null ? this.refreshDelegate(save) : new xrmpromise_mock_1.XrmPromiseMock(new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, resolve(undefined)];
        }); }); }));
    };
    DataMock.prototype.save = function (saveOptions) {
        var _this = this;
        return this.saveDelegate != null ? this.saveDelegate(saveOptions) : new xrmpromise_mock_1.XrmPromiseMock(new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, resolve(undefined)];
        }); }); }));
    };
